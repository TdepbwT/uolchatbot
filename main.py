...
def read_context_from_file(folder_path):# function to read the context from a file
    context = ""
...
folder_path = input("enter the file path containing the context: ")

context = read_context_from_file(folder_path)
